...
import { Image, View, Text, StyleSheet, FlatList, TouchableOpacity, Button } from 'react-native';
            ...
            renderItem={(post, index) =>{
              return (
                ...
                <TouchableOpacity
                  ...
                  onPress={() => navigation.push('Post', {url: post.item.downloadURL, type: post.item.contentType})}
                >
                {
